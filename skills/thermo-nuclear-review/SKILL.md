...
# Final Response
IF you have medium-to-high priority / risk findings, and there is a PR for this branch, then check the PR/MR discussion using gh/glab cli to see if there are comments from automated review bots (e.g. Bugbot) or humans.
...
Flag bot- or human-sourced issues from the PR/MR discussion that you include in your report.
